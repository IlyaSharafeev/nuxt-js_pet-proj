...
.fancybox-is-zoomable.fancybox-can-drag {
  .fancybox-close-small {
    display: none;
  }
}
...
#soc.open_folder_solo {
  position: absolute;
  top: 10%;
  right: 10%;
}
#about.open_folder_solo {
  position: absolute;
  top: 15%;
  right: 15%;
}
#skills.open_folder_solo {
  position: absolute;
  top: 20%;
  right: 20%;
}
.open_folder_solo.active {
  visibility: visible;
  opacity: 1;
